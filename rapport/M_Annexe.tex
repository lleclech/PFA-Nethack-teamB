\chapter*{Annexe 1 - Document de spécification}
...
Ce module permettra d'accéder aux données qui serviront de point de comparaison des bots,
...
\chapter*{Annexe 2 - Diagramme de classe du bot}

\begin{figure}
\center
\includegraphics[angle=90, width= 140mm]{Images/Diagramme_classe.jpeg}
\caption{Diagramme de classe des bots}
\end{figure}
