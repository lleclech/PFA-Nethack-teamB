...
Nous avons codés deux bots relativement simple en java. L'un est aléatoire, l'autre est plus évolué. Nous allons ici décrir le fonctionnement du second.

\subsection{Diagramme de classe}

\includegraphics{Images/diagramme_bot.jpeg} 
